...
QT_MOC_LITERAL(4, 30, 5) // "level"
    ...
    "ProcessThread\0PrintMyLog\0\0msg\0level"
};
...
void ProcessThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (ProcessThread::*_t)(QString , const int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ProcessThread::PrintMyLog)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void ProcessThread::PrintMyLog(QString _t1, const int _t2)
{
