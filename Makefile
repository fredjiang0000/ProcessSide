#############################################################################
# Makefile for building: ProcessSide
# Generated by qmake (3.0) (Qt 5.4.0)
# Project:  VSS(Capture and Process).pro
# Template: app
# Command: C:\Qt\Qt5.4.0\5.4\mingw491_32\bin\qmake.exe -spec win32-g++ -o Makefile "VSS(Capture and Process).pro"
#############################################################################
...
Makefile: VSS(Capture\ and\ Process).pro C:/Qt/Qt5.4.0/5.4/mingw491_32/mkspecs/win32-g++/qmake.conf C:/Qt/Qt5.4.0/5.4/mingw491_32/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -spec win32-g++ -o Makefile "VSS(Capture and Process).pro"
